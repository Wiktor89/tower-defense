...
export function showSolarSystemReward(completion: StageCompletion, onClose: () => void): void {
  ...
  overlay.innerHTML = `
    <div class="solar-modal">
      <h2 class="solar-title">🎉 Серия пройдена!</h2>
      <p class="solar-reward">Вы заработали <strong>${completion.rewardRub}₽</strong></p>
      <p class="solar-hint">Запомните цифру на планете — администратор проверит её</p>
